...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ ">_", "2", "</>", "4", "5", "6", "7", "8", "@" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Custom Hotkeys
    awful.key({ modkey, "Shift"   }, "f", function () awful.spawn("firefox duckduckgo.com") end,
...
awful.spawn.with_shell("picom --blur-background")
